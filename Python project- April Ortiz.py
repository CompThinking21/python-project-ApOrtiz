#This project was created to help users in finding a crystal that best suites them.

#These are list of the types of crystals that will be used in this project as well with
#with their description and their values
...
#This is used in the beginning of the quiz to welcome them to the quiz and to begin the quiz
...
if cq_1 == "yes":
    ...
    print("Boo you suck!")
#These are the list of questions used in the quiz to help
#decide what crystal is best suited for the user.
#this was used with if and elif statements and each one has a value of 5 so when the user decides
#on their answers it will calcuate the answer.
...
if cq_6 == "a":
    ...
    print("Sorry, I don't understand that answer.")
#helps decide on the answer and decides which crystal is best suited for the user.
#the for and if statements helps decide on the value and crystal
